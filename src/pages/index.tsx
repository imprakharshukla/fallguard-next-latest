            ...
            <main className={"min-h-screen"}>
                <section className="bg-white dark:bg-gray-900">
                    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                        ...
                        {/*            <svg className="h-8" viewBox="0 0 132 29" fill="none"*/}
                        {/*                 xmlns="http://www.w3.org/2000/svg">*/}
                        {/*                <path*/}
                        ...
                        {/*                    fill="currentColor"/>*/}
                        {/*                <path d="M16.4609 8.77612V20.6816L26.7966 14.7289L16.4609 8.77612Z"*/}
                        {/*                      fill="white"/>*/}
                        {/*                <path*/}
                        ...
                        {/*        </a>*/}
                        {/*        <a href="#" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">*/}
                        {/*            <svg className="h-11" viewBox="0 0 208 42" fill="none"*/}
                        {/*                 xmlns="http://www.w3.org/2000/svg">*/}
                        {/*                <path*/}
                        ...
                        {/*        </a>*/}
                        {/*        <a href="#" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">*/}
                        {/*            <svg className="h-11" viewBox="0 0 120 41" fill="none"*/}
                        {/*                 xmlns="http://www.w3.org/2000/svg">*/}
                        {/*                <path*/}
